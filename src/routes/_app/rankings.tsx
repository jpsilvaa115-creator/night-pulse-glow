        ...
        <div className="mt-6 grid grid-cols-3 gap-3 items-end">
          {[1, 0, 2].map((order) => {
            ...
            return (
              ...
              >
                <div className={`h-14 w-14 rounded-full bg-gradient-neon grid place-items-center font-display font-bold text-lg ${isFirst ? "glow-neon scale-110" : ""}`}>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-muted-foreground truncate">{r.user.bio}</div>
              </div>
